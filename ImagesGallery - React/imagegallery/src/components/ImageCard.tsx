...
export const ImageCard: React.FC<ImageCardProps> = ({ nome, tamanho, dataUpload, src, extension }: ImageCardProps) => {
    ...
    return (
        <div className="card relative bg-white rounded-md shadow-md transition-transform ease-in duration-300 transform hover:shadow-lg">
            ...
            <div className="card-body p-4">
                ...
                <button className='bg-yellow-500 text-white px-3 py-2 rounded-md hover:bg-yellow-600' onClick={download}>Salvar</button>
            </div>
        </div>
